  ...
  const quickActions = [
    {
      ...
      description: 'Let\'s discuss your project requirements and how I can help bring your ideas to life.',
      action: 'Start a Project'
    },
    {
      title: 'Technical Consultation',
      description: 'Need advice on technology choices, architecture, or best practices? I\'m here to help.',
      action: 'Get Consultation'
    },
    {
      title: 'Speaking & Mentoring',
      description: 'Interested in having me speak at your event or mentor your development team?',
        ...
        <div className="container-custom">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Ready to collaborate on your next project? I'd love to hear about your ideas 
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {quickActions.map((action, index) => (
              <Card key={action.title} className="border-0 shadow-lg hover-glow transition-all duration-300 text-center">
